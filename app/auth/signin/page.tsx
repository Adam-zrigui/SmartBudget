        ...
        <div className="hidden lg:flex flex-col justify-center max-w-md animate-in fade-in slide-in-from-left-8 duration-700">
          ...
          <div className="space-y-4">
            {features.map((feature, i) => (
              <div
                key={i}
                className="p-4 rounded-2xl bg-white/30 dark:bg-base-800/40 backdrop-blur-sm border border-white/20 dark:border-base-700/30 hover:bg-white/40 dark:hover:bg-base-700/50 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-in fade-in slide-in-from-left-8 duration-700 group cursor-pointer"
